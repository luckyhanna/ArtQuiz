...
//        Single chioice questions
        ...
        questionList.add(new Question(R.drawable.mona_lisa, PAINTING_QUESTION, answerMap1,
        ...
        questionList.add(new Question(R.drawable.starry_night, PAINTING_QUESTION, answerMap2,
        ...
        questionList.add(new Question(R.drawable.girl_with_a_pearl_earring, PAINTING_QUESTION, answerMap4,
        ...
        questionList.add(new Question(R.drawable.the_last_supper, PAINTING_QUESTION, answerMap5,
        ...
        questionList.add(new Question(R.drawable.the_scream, PAINTING_QUESTION, answerMap6,
        ...
        questionList.add(new Question(R.drawable.american_gothic, PAINTING_QUESTION, answerMap7,
        ...
        questionList.add(new Question(R.drawable.the_creation_of_adam, PAINTING_QUESTION, answerMap8,
        ...
        questionList.add(new Question(R.drawable.the_persistence_of_memory, PAINTING_QUESTION, answerMap9,
        ...
        questionList.add(new Question(R.drawable.david, SCULPTURE_QUESTION, answerMap10,
        ...
        questionList.add(new Question(R.drawable.the_birth_of_venus, PAINTING_QUESTION, answerMap11,
        ...
        questionList.add(new Question(R.drawable.a_sunday_afternoon, PAINTING_QUESTION, answerMap12,
        ...
        questionList.add(new Question(R.drawable.whistlers_mother, PAINTING_QUESTION, answerMap13,
        ...
        questionList.add(new Question(R.drawable.self_portrait_without_beard, PAINTING_QUESTION, answerMap14,
        ...
        questionList.add(new Question(R.drawable.the_kiss, PAINTING_QUESTION, answerMap15,
        ...
        questionList.add(new Question(R.drawable.the_anatomy_lesson, PAINTING_QUESTION, answerMap16,
...
*/
        ...
        questionList.add(new Question(R.drawable.haystacks_midday, PAINTING_QUESTION, answerMap18,
        ...
        questionList.add(new Question(R.drawable.springtime, PAINTING_QUESTION, answerMap19,
        ...
        questionList.add(new Question(R.drawable.dali, "In what year was Salvador Domingo Felipe Jacinto Dalí born?",
