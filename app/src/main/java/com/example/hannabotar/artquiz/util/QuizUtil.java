...
public class QuizUtil {
    ...
    public static List<Question> initMockData() {
        ...
        questionList.add(new Question(R.drawable.mona_lisa, "Name the painting: ", answerMap1,
                "The Mona Lisa by Leonardo da Vinci is \"the best known, the most visited, the most written about, the most sung about, the most parodied work of art\" and also one of the most valuable paintings in the world, and has been displayed at the Louvre Museum in Paris since 1797."));
        ...
        questionList.add(new Question(R.drawable.starry_night, "Name the painting: ", answerMap2,
                "The Starry Night by Vincent van Gogh is regarded as among the artist's finest works and is one of the most recognized paintings in the history of Western culture. It depicts the view from the east-facing window of his asylum room just before sunrise. The painting has been in the permanent collection of the Museum of Modern Art in New York City since 1941."));
        ...
        questionList.add(new Question(R.drawable.venus_de_milo, "Name the sculpture: ", answerMap3,
                "Aphrodite of Milos, better known as the Venus de Milo, is an ancient Greek statue and one of the most famous works of ancient Greek sculpture. It is thought to be the work of Alexandros of Antioch, created sometime between 130 and 100 BC. It is currently on permanent display at the Louvre Museum in Paris."));
        ...
        questionList.add(new Question(R.drawable.girl_with_a_pearl_earring, "Name the painting: ", answerMap4,
                "Girl with a Pearl Earring by Johannes Vermeer is a tronie of a girl wearing an exotic dress, an oriental turban, and an improbably large pearl earring. The painting has been in the collection of the Mauritshuis in The Hague since 1902."));
        ...
        questionList.add(new Question(R.drawable.the_last_supper, "Name the painting: ", answerMap5,
                "The Last Supper by Leonardo da Vinci is a late 15th-century mural painting housed by the refectory of the Convent of Santa Maria delle Grazie in Milan. It is one of the world's most recognizable paintings."));
        ...
        questionList.add(new Question(R.drawable.the_scream, "Name the painting: ", answerMap6,
                "Der Schrei der Natur (The Scream of Nature) by Edvard Munch has four versions, two painted and two pastel versions. The works show a figure with an agonized expression against a landscape with a tumultuous orange sky."));
        ...
        questionList.add(new Question(R.drawable.american_gothic, "Name the painting: ", answerMap7,
                "American Gothic is a painting by Grant Wood in the collection of the Art Institute of Chicago, depicting a farmer standing beside a woman who has been interpreted to be his daughter or his wife. It is one of the most familiar images in 20th-century American art and has been widely parodied in American popular culture."));
        ...
        questionList.add(new Question(R.drawable.the_creation_of_adam, "Name the painting: ", answerMap8,
                "The Creation of Adam is a fresco painting by Michelangelo, which forms part of the Sistine Chapel's ceiling. It illustrates the Biblical creation narrative from the Book of Genesis in which God breathes life into Adam, the first man."));
        ...
        questionList.add(new Question(R.drawable.the_persistence_of_memory, "Name the painting: ", answerMap9,
                "The Persistence of Memory is a 1931 painting by artist Salvador Dalí, and is one of his most recognizable works. Since 1934 the painting has been in the collection of the Museum of Modern Art (MoMA) in New York City. The painting was inspired by the surrealist perception of a Camembert melting in the sun."));
        ...
        questionList.add(new Question(R.drawable.david, "Name the painting: ", answerMap10,
                "David is a masterpiece of Renaissance sculpture created in marble between 1501 and 1504 by Michelangelo. David is a 5.17-metre marble statue of a standing male nude. The statue represents the Biblical hero David, a favoured subject in the art of Florence."));
        ...
        questionList.add(new Question(R.drawable.the_birth_of_venus, "Name the painting: ", answerMap11,
                "The Birth of Venus by Sandro Botticelli is a painting that depicts the goddess Venus arriving at the shore after her birth, when she had emerged from the sea fully-grown (called Venus Anadyomene and often depicted in art). The painting is in the Uffizi Gallery in Florence, Italy."));
        ...
        questionList.add(new Question(R.drawable.a_sunday_afternoon, "Name the painting: ", answerMap12,
                "A Sunday Afternoon on the Island of La Grande Jatte painted in 1884, is one of Georges Seurat's most famous works. It is a leading example of pointillist technique, executed on a large canvas. Seurat's composition includes a number of Parisians at a park on the banks of the River Seine."));
        ...
        questionList.add(new Question(R.drawable.self_portrait_without_beard, "Name the painting: ", answerMap14,
                "Self-portrait without beard is an 1889 oil on canvas painting by the post-impressionist artist Vincent van Gogh. It may have been Van Gogh's last self-portrait. It is one of the most expensive paintings of all time, selling for $71.5 million in 1998 in New York City."));
        ...
        questionList.add(new Question(R.drawable.the_kiss, "Name the painting: ", answerMap15,
                "The Kiss (Lovers) was painted by the Austrian Symbolist painter Gustav Klimt between 1907 and 1908. The work is composed of oil paint with applied layers of gold leaf, an aspect that gives it its strikingly modern, yet evocative appearance. The painting is now in the Österreichische Galerie Belvedere museum in the Belvedere palace, Vienna."));
        ...
        questionList.add(new Question(R.drawable.pieta, "Name the painting: ", answerMap20,
                "The Pietà is a work of Renaissance sculpture by Michelangelo Buonarroti, housed in St. Peter's Basilica, Vatican City. This famous work of art depicts the body of Jesus on the lap of his mother Mary after the Crucifixion."));
